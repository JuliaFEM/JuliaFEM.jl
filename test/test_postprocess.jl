...
@test isnan(problem("temperature", [-0.1]))
@test isapprox(problem("temperature", [0.0]), [0.0])
@test isapprox(problem("temperature", [0.5]), [0.5])
@test isapprox(problem("temperature", [1.0]), [1.0])
@test isapprox(problem("temperature", [1.5]), [0.5])
@test isapprox(problem("temperature", [2.0]), [0.0])
@test isnan(problem("temperature", [ 2.1]))
