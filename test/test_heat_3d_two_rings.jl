...
rings_elements = create_elements(mesh, "RING1", "RING2")
update!(rings_elements, "thermal conductivity", 1.0)
...
@debug("# of elements in RING1_INNER and RING2_OUTER",
        length(bc_inner_elements), length(bc_outer_elements))
add_elements!(rings, rings_elements)
