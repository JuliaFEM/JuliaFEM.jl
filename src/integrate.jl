...
integration_rule_mapping = (
    ...
    :Quad4   => (:GLQUAD1, :GLQUAD4, :GLQUAD9, :GLQUAD16, :GLQUAD25),
    :Quad8   => (:GLQUAD4, :GLQUAD9, :GLQUAD16, :GLQUAD25),
    :Quad9   => (:GLQUAD4, :GLQUAD9, :GLQUAD16, :GLQUAD25),
    :NSurf   => (:GLQUAD4, :GLQUAD9, :GLQUAD16, :GLQUAD25),
    :Hex8    => (:GLHEX1, :GLHEX27, :GLHEX81, :GLHEX243),
