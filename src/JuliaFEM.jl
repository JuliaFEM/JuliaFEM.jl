...
include("quadrature/quaddata.jl")     # Quadrature data constants (needed by glquad.jl)
include("quadrature/gltet.jl")        # Tetrahedron quadrature points
include("quadrature/gltri.jl")        # Triangle quadrature points
include("quadrature/glwed.jl")        # Wedge quadrature points
include("quadrature/glpyr.jl")        # Pyramid quadrature points
include("quadrature/glquad.jl")       # Quadrilateral quadrature points
...
# Export plate basis types (NEW - November 2025)
